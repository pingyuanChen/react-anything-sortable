...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sortable = _react2['default'].createClass({
	  ...
	  propTypes: {
	    ...
	    disableVertical: _react.PropTypes.bool
	  },
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    _utils.on(container, 'scroll', (function () {
	  ...
	  getOrderTotalWidth: function getOrderTotalWidth() {
	    var total = 0;
	  ...
	  _resetContainerState: function _resetContainerState() {
	    var container = _reactDom2['default'].findDOMNode(this);
